...
#include "PlayableCharacter/Notify/Skill/BuffSkillAnimNotify.h"
...
void UBuffSkillAnimNotify::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	if (!MeshComp)
		return;
	...
	if (SkillActionComp)
	{
		...
		SkillActionComp->FireBuffSkill(SkillData);
	}
}
